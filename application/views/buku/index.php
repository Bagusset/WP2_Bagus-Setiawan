            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    foreach ($buku as $b) { ?> <tr>
                            ...
                            <td>
                                <picture>
                                    <source srcset="" type="image/svg+xml"> <img style="width: 100px;" src="<?= base_url('assets/img/uploud/') . $b['image']; ?>" class="img-fluid img-thumbnail" alt="...">
                                </picture>
                            </td>
                            <td>
...
<div class="modal fade" id="bukuBaruModal" tabindex="-1" role="dialog" aria-labelledby="bukuBaruModal" ariahidden="true">
